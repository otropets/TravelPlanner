package org.otropets.travelplanner.participant.service;
...
public class ParticipantService {
    ...
    public ParticipantResponse inviteParticipant(Long tripId, InviteRequest request){
        ...
        Optional<Participant> existing = participantRepository.findByTripAndUser(trip, user);
        if (existing.isPresent()) {
            throw new ConflictException("User is already a participant of this trip");
        }
